...
const heaters1: Array<HeaterRegulationMode> = [HeaterRegulationMode.CONTACTOR, HeaterRegulationMode.SOLID_RELAY];
...
alg.heaterControllers1[1].connectPort(A4.DO3);
