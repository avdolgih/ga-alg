...
export default {
  ...
  V23: new HMI([
    ...
    new Label(50, 200, 150, 0, "black", 50, "В23"),
    new Switch(160, 200, 200, 0, "black", 50, new TopicBool("В23", "Работает", "Ожидает")),
    new Label(460, 200, 150, 0, "black", 50, "Температура"),
    new Input(
      780,
      200,
      110,
    ...
    new Label(925, 200, 150, 0, "black", 50, "C°"),
    new Button(
      15,
      380,
      280,
