...
export default {
  AV1: new HMI([
    ...
    new Error(15, 500, 994, 320, new TopicVal("ERROR", "")),
  ]),
  V5: new HMI([
  ...
  P10P10R: new HMI([
    ...
    new Label(500, 200, 290, 0, "black", 50, "t притока"),
    new Input(760, 190, 115, 65, "black", "white", 50, "100", true, new TopicVal("/heater/get", ""), new TopicVal("", "")),
    new Label(900, 200, 150, 0, "black", 50, "С°"),
    new Label(500, 290, 300, 0, "black", 50, "Уставка t"),
    new Input(
      760,
      285,
      115,
